        ...
        if( candies.size() > 0 ) {
          ...
          // create an array of candy buttons
            ...
            for ( Candy candy : candies ) {
                ...
                grid.addView(buttons[i], width, GridLayout.LayoutParams.WRAP_CONTENT);
                i++;
            }
            ...
            grid.addView(emptyText,( int ) ( width ), ViewGroup.LayoutParams.WRAP_CONTENT );
            grid.addView( btnBack, ( int ) ( width ), ViewGroup.LayoutParams.WRAP_CONTENT );
